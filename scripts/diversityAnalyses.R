...
fviz_pca_ind(pca, habillage=merge$MachRes1, geom="point", pointsize=3, mean.point=FALSE) + labs(title="Bray Curtis Distance") + theme_classic()
dev.off()
pdf("figs/braycurtis_pca_species.pdf")
fviz_pca_ind(pca, habillage=merge$Sp_by_key, geom="point", pointsize=3, mean.point=FALSE) + labs(title="Bray Curtis Distance") + theme_classic()
dev.off()
...
fviz_pca_ind(pca, habillage=merge$MachRes1, geom="point", pointsize=3, mean.point=FALSE) + labs(title="Weighted Unifrac Distance") + theme_classic()
dev.off()
pdf("figs/wunifrac_pca_species.pdf")
fviz_pca_ind(pca, habillage=merge$Sp_by_key, geom="point", pointsize=3, mean.point=FALSE) + labs(title="Weighted Unifrac Distance") + theme_classic()
dev.off()
